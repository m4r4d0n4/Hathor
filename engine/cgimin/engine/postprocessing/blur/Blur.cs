...
namespace cgimin.engine.postprocessing.blur
{
    public class Blur : BasePostProcessing
    {
        ...
        public Blur(): base()
        {
            ...
            Program = ShaderCompiler.CreateShaderProgram("cgimin/engine/postprocessing/blur/Blur_VS.glsl",
                                                         "cgimin/engine/postprocessing/blur/Blur_FS.glsl");
            ...
            blurDirectionLocation = GL.GetUniformLocation(Program, "blurDirection");
        }


        public void Draw(int sourceTexture, int screenWidth, int screenHeight, Vector2 blurDirection)
        {
            ...
            // pass blur direction
            GL.Uniform2(blurDirectionLocation, blurDirection);
