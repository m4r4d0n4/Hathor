...
namespace cgimin.engine.material.gbufferreceiveshadowlayout
{
    public class GBufferReceiveShadowLayoutMaterial : BaseMaterial
    {
        ...
        public GBufferReceiveShadowLayoutMaterial()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram("cgimin/engine/material/gbufferreceiveshadowlayout/GBufferReceiveShadowLayout_VS.glsl",
                                "cgimin/engine/material/gbufferreceiveshadowlayout/GBufferReceiveShadowLayout_FS.glsl");
